...
public class addProduct extends JPanel {
    ...
    public addProduct() {
        ...
        try {
            backgroundImage = ImageIO.read(new File("C:\\Users\\ADMIN\\Downloads\\FINAL\\Cafe Encanto\\images\\add p bg.png")); // Replace with your image path
        } catch (IOException e) {
        ...
        idField.setColumns(20); // Set the maximum length to 20 characters
        ...
        btnAddProduct.setBackground(new Color(92, 64, 51)); // Button background color
        ...
        btnAddProduct.addActionListener((ActionEvent arg0) -> {
            if (quanField.getText().isEmpty() || idField.getText().isEmpty()) {
                ...
                try {
                    ...
                    // Call your DB method to add product
